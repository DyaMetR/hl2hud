...
SCHEME:Font('WeaponIcons', 'HalfLife2', 46, 0, true, nil, nil, nil, HL2HUD.FONTSCALING_LIMITED)
SCHEME:Font('AmmoIcons', 'gstring2', 38, 0, true, 0, 2)
SCHEME:Font('FlashlightIcon', 'gstring2', 32, 0, true, 0, 2)
SCHEME:Font('WeaponIconsSmall', 'HalfLife2', 28, 0, true, 0, 2, nil, HL2HUD.FONTSCALING_LIMITED)
SCHEME:Font('WeaponIconsSmallMP', 'HL2MP', 28, 0, true, 0, 2, nil, HL2HUD.FONTSCALING_LIMITED)
SCHEME:Font('Crosshairs', 'gstring_crosshairs', 40, 0, true, nil, nil, nil, HL2HUD.FONTSCALING_NONE, false)
